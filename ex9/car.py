class Car:
    """
    this class is car class, it makes a car objects according to the
    instructions
    """
    ...
    def car_coordinates(self):
        ...
        if self.orientation == 0:
            for index in range(1, self.length):
                lst.append(tuple([self.location[0]+index, self.location[1] ]))
            return lst
        if self.orientation == 1:
            for index in range(1, self.length):
                lst.append(
                    tuple([self.location[0], self.location[1]+index]))
            return lst

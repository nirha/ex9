class Car:
    ...
    def car_coordinates(self):
        ...
        if self.__orientation == 0:
            ...
            for index in range(1, self.__length):
                lst.append(
                    tuple([self.__location[0] + index, self.__location[1]]))
            return lst
        if self.__orientation == 1:
            # in case the car is horizontal
            for index in range(1, self.__length):
                lst.append(
                    tuple([self.__location[0], self.__location[1] + index]))
            return lst
    ...
    def movement_requirements(self, movekey):
        ...
        # implement your code and erase the "pass"
        last = self.car_coordinates()[self.__length - 1]
        if self.__orientation == 0:
            # in case the car is vertical
            if movekey == "u":
                return [tuple([self.__location[0] - 1, self.__location[1]])]
            if movekey == "d":
                return [tuple([last[0] + 1, self.__location[1]])]
        if self.__orientation == 1:
            # in case the car is horizontal
            if movekey == "r":
                return [tuple([self.__location[0], last[1] + 1])]
            if movekey == "l":
                return [tuple([self.__location[0], self.__location[1] - 1])]
